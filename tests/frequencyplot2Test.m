function tests = frequencyplot2Test
...
frequencyplot2('imaging_preprocessed','resultsdir','../Results_test','frequencies',[10,20,40,80],'pulselengths',[10],'neuronparts',{'AOTu'},'inhibitor_conc',[0])
...
frequencyplot2('imaging_preprocessed','resultsdir','../Results_test','frequencies',[40],'pulselengths',[10,20],'neuronparts',{'AOTu'},'genders',{'_male'},'inhibitor_conc',[0])
...
frequencyplot2('2020_01_16','resultsdir','../Results_test','frequencies',[40],'pulselengths',[10],'neuronparts',{'AOTu'},'genders',{'_male'},'inhibitor_conc',[0])
cd (currentdir);
...
frequencyplot2('imaging_preprocessed','resultsdir','../Results_test','frequencies',[40],'pulselengths',[10],'neuronparts',{'AOTu'},'genders',{'_male'},'pulsetimesfromfile', true,'inhibitor_conc',[0])
