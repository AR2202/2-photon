...
outputimgs=strcat(foldername,'_oenocytelessM_mROI.eps');
outputfiley=strcat(foldername,'_ball_mROI.xlsx');
outputimgy=strcat(foldername,'_ball_mROI.eps');
outputfilem=strcat(foldername,'_male_mROI.xlsx');
outputimgm=strcat(foldername,'_male_mROI.eps');
ee = 1;
ii = 1;
virgin = 0;
