...
%calculations
[touchstartframes,eventsmat,eventpeaks,eventpeaks_mean,eventpeaks_SEM,mean_event,SEM_event,touchtimes,fluo,x_events,mean_event_peak_aligned,SEM_event_peak_aligned]= cellfun(@(data_arr) find_touch_events(data_arr,options), data_array, 'UniformOutput', false);
[touchstartframes_contra,eventsmat_contra,eventpeaks_contra,eventpeaks_mean_contra,eventpeaks_SEM_contra,mean_event_contra,SEM_event_contra,touchtimes_contra,fluo_contra,x_events_contra,mean_event_peak_aligned_contra,SEM_event_peak_aligned_contra]= cellfun(@(data_arr) find_touch_events(data_arr,options), data_array_swapped, 'UniformOutput', false);
...
combinedtable_unfiltered=table(eventpeaks_mean, mean_event, mean_event_peak_aligned, t_foundfilename,t_foundin,eventsmat);
combinedtable_contra_unfiltered=table(eventpeaks_mean_contra, mean_event_contra, mean_event_peak_aligned_contra, t_foundfilename,t_foundin,eventsmat_contra);
...
vir_n_m=size(cell_mean_event_m,2);
cell_mean_event_peak_aligned_m=cell2mat(transpose(virtable_m.mean_event_peak_aligned(~cellfun(@isempty, virtable_m.mean_event_peak_aligned))));

vir_mean_event_peak_aligned_m=mean(cell_mean_event_peak_aligned_m,2);
vir_SEM_event_peak_aligned_m=std(cell_mean_event_peak_aligned_m,0,2)/sqrt(size(cell_mean_event_peak_aligned_m,2));
...
vir_n_m=size(cell_mean_event_m,2);
cell_mean_event_peak_aligned_m_contra=cell2mat(transpose(virtable_m_contra.mean_event_peak_aligned_contra(~cellfun(@isempty, virtable_m_contra.mean_event_peak_aligned_contra))));

vir_mean_event_peak_aligned_m_contra=mean(cell_mean_event_peak_aligned_m_contra,2);
vir_SEM_event_peak_aligned_m_contra=std(cell_mean_event_peak_aligned_m_contra,0,2)/sqrt(size(cell_mean_event_peak_aligned_m_contra,2));
...
male_n_m=size(cell_mean_event_m,2);
cell_mean_event_peak_aligned_m=cell2mat(transpose(maletable_m.mean_event_peak_aligned(~cellfun(@isempty, maletable_m.mean_event_peak_aligned))));
...
cell_mean_event_peak_aligned_m_contra=cell2mat(transpose(maletable_m_contra.mean_event_peak_aligned_contra(~cellfun(@isempty, maletable_m_contra.mean_event_peak_aligned_contra))));
...
oenegm_n_m=size(cell_mean_event_m,2);
...
oenegf_n_m=size(cell_mean_event_m,2);
...
ball_n_m=size(cell_mean_event_m,2);
...
cell_mean_event_peak_aligned_f=cell2mat(transpose(virtable_f.mean_event_peak_aligned(~cellfun(@isempty, virtable_f.mean_event_peak_aligned))));

vir_mean_event_peak_aligned_f=mean(cell_mean_event_peak_aligned_f,2);
vir_SEM_event_peak_aligned_f=std(cell_mean_event_peak_aligned_f,0,2)/sqrt(size(cell_mean_event_peak_aligned_f,2));
vir_n_f=size(cell_mean_event_f,2);
...
cell_mean_event_peak_aligned_f_contra=cell2mat(transpose(virtable_f_contra.mean_event_peak_aligned_contra(~cellfun(@isempty, virtable_f_contra.mean_event_peak_aligned_contra))));

vir_mean_event_peak_aligned_f_contra=mean(cell_mean_event_peak_aligned_f_contra,2);
vir_SEM_event_peak_aligned_f_contra=std(cell_mean_event_peak_aligned_f_contra,0,2)/sqrt(size(cell_mean_event_peak_aligned_f_contra,2));
...
cell_mean_event_peak_aligned_f=cell2mat(transpose(maletable_f.mean_event_peak_aligned(~cellfun(@isempty, maletable_f.mean_event_peak_aligned))));

male_mean_event_peak_aligned_f=mean(cell_mean_event_peak_aligned_f,2);
male_SEM_event_peak_aligned_f=std(cell_mean_event_peak_aligned_f,0,2)/sqrt(size(cell_mean_event_peak_aligned_f,2));
male_n_f=size(cell_mean_event_f,2);
...
cell_mean_event_peak_aligned_f_contra=cell2mat(transpose(maletable_f_contra.mean_event_peak_aligned_contra(~cellfun(@isempty, maletable_f_contra.mean_event_peak_aligned_contra))));

male_mean_event_peak_aligned_f_contra=mean(cell_mean_event_peak_aligned_f_contra,2);
male_SEM_event_peak_aligned_f_contra=std(cell_mean_event_peak_aligned_f_contra,0,2)/sqrt(size(cell_mean_event_peak_aligned_f_contra,2));
...
oenegm_n_f=size(cell_mean_event_f,2);
...
oenegf_n_f=size(cell_mean_event_f,2);
...
ball_n_f=size(cell_mean_event_f,2);
...
vir_n_mf=size(cell_mean_event_mf,2);

cell_mean_event_peak_aligned_mf=cell2mat(transpose(virtable_mf.mean_event_peak_aligned(~cellfun(@isempty, virtable_mf.mean_event_peak_aligned))));

vir_mean_event_peak_aligned_mf=mean(cell_mean_event_peak_aligned_mf,2);
vir_SEM_event_peak_aligned_mf=std(cell_mean_event_peak_aligned_mf,0,2)/sqrt(size(cell_mean_event_peak_aligned_mf,2));
...
cell_mean_event_peak_aligned_mf_contra=cell2mat(transpose(virtable_mf_contra.mean_event_peak_aligned_contra(~cellfun(@isempty, virtable_mf_contra.mean_event_peak_aligned_contra))));

vir_mean_event_peak_aligned_mf_contra=mean(cell_mean_event_peak_aligned_mf_contra,2);
vir_SEM_event_peak_aligned_mf_contra=std(cell_mean_event_peak_aligned_mf_contra,0,2)/sqrt(size(cell_mean_event_peak_aligned_mf_contra,2));
...
cell_mean_event_peak_aligned_mf=cell2mat(transpose(maletable_mf.mean_event_peak_aligned(~cellfun(@isempty, maletable_mf.mean_event_peak_aligned))));

male_mean_event_peak_aligned_mf=mean(cell_mean_event_peak_aligned_mf,2);
male_SEM_event_peak_aligned_mf=std(cell_mean_event_peak_aligned_mf,0,2)/sqrt(size(cell_mean_event_peak_aligned_mf,2));
male_n_mf=size(cell_mean_event_mf,2);
...
cell_mean_event_peak_aligned_mf_contra=cell2mat(transpose(maletable_mf_contra.mean_event_peak_aligned_contra(~cellfun(@isempty, maletable_mf_contra.mean_event_peak_aligned_contra))));

male_mean_event_peak_aligned_mf_contra=mean(cell_mean_event_peak_aligned_mf_contra,2);
male_SEM_event_peak_aligned_mf_contra=std(cell_mean_event_peak_aligned_mf_contra,0,2)/sqrt(size(cell_mean_event_peak_aligned_mf_contra,2));
...
oenegm_n_mf=size(cell_mean_event_mf,2);
...
oenegf_n_mf=size(cell_mean_event_mf,2);
...
ball_n_mf=size(cell_mean_event_mf,2);
...
try
    ...
    plot_vir_event_m_peak_aligned=boundedline(xevents_nonempty{1,1},vir_mean_event_peak_aligned_m,vir_SEM_event_peak_aligned_m,'c');
    cd(outputdirmean);
    saveas(fignew,'virgin_mean_event_males_ipsi','epsc');
    save('mean_male_touching_female_ipsi.mat','vir_n_m','vir_mean_event_m','vir_SEM_event_m','vir_eventpeaks_mean_m','vir_eventpeaks_SEM_m');
catch ME
...
try
    ...
    plot_vir_event_m_contra_peak_aligned=boundedline(xevents_nonempty_contra{1,1},vir_mean_event_peak_aligned_m_contra,vir_SEM_event_peak_aligned_m_contra,'c');
    
    cd(outputdirmean);
    saveas(fignew,'virgin_mean_event_male_contra','epsc');
    save('mean_male_touching_female_contra.mat','vir_n_m','vir_mean_event_m_contra','vir_SEM_event_m_contra','vir_eventpeaks_mean_m_contra','vir_eventpeaks_SEM_m_contra');
...
try
    ...
    plot_vir_event_f_peak_aligned=boundedline(xevents_nonempty{1,1},vir_mean_event_peak_aligned_f,vir_SEM_event_peak_aligned_f,'c');
    
    cd(outputdirmean);
    saveas(fignew,'virgin_mean_event_female_ipsi','epsc');
    save('mean_female_touching_female_ipsi.mat','vir_mean_event_f','vir_n_f','vir_SEM_event_f','vir_eventpeaks_mean_f','vir_eventpeaks_SEM_f','vir_mean_event_peak_aligned_f','vir_SEM_event_peak_aligned_f');
...
try
    ...
    plot_vir_event_f_contra_peak_aligned=boundedline(xevents_nonempty_contra{1,1},vir_mean_event_peak_aligned_f_contra,vir_SEM_event_peak_aligned_f_contra,'c');
    
    cd(outputdirmean);
    saveas(fignew,'virgin_mean_event_female_contra','epsc');
    save('mean_female_touching_female_contra.mat','vir_n_f','vir_mean_event_f_contra','vir_SEM_event_f_contra','vir_eventpeaks_mean_f_contra','vir_eventpeaks_SEM_f_contra','vir_mean_event_peak_aligned_f_contra','vir_SEM_event_peak_aligned_f_contra');
...
try
    ...
    plot_vir_event_mf_peak_aligned=boundedline(xevents_nonempty{1,1},vir_mean_event_peak_aligned_mf,vir_SEM_event_peak_aligned_mf,'c');
    cd(outputdirmean);
    saveas(fignew,'virgin_mean_event_mated_female_ipsi','epsc');
    save('mean_mated_female_touching_female_ipsi.mat','vir_n_mf','vir_mean_event_mf','vir_SEM_event_mf','vir_eventpeaks_mean_mf','vir_eventpeaks_SEM_mf','vir_mean_event_peak_aligned_mf','vir_SEM_event_peak_aligned_mf');
...
try
    ...
    plot_vir_event_mf_contra=boundedline(xevents_nonempty_contra{1,1},vir_mean_event_peak_aligned_mf_contra,vir_SEM_event_peak_aligned_mf_contra,'c');
    
    cd(outputdirmean);
    saveas(fignew,'virgin_mean_event_mated_female_contra','epsc');
    save('mean_mated_female_touching_female_contra.mat','vir_n_mf','vir_mean_event_mf_contra','vir_SEM_event_mf_contra','vir_eventpeaks_mean_mf_contra','vir_eventpeaks_SEM_mf_contra','vir_mean_event_peak_aligned_mf_contra','vir_SEM_event_peak_aligned_mf_contra');
...
try
    ...
    plot_male_event_m_peak_aligned=boundedline(xevents_nonempty{1,1},male_mean_event_peak_aligned_m,male_SEM_event_peak_aligned_m,'c');
    cd(outputdirmean);
    saveas(fignew,'male_mean_event_male_ipsi','epsc');
    save('mean_male_touching_male_ipsi.mat','male_mean_event_m','male_n_m','male_SEM_event_m','male_eventpeaks_mean_m','male_eventpeaks_SEM_m','male_mean_event_peak_aligned_m','male_SEM_event_peak_aligned_m');
...
try
    ...
    plot_male_event_m_contra_peak_aligned=boundedline(xevents_nonempty_contra{1,1},male_mean_event_peak_aligned_m_contra,male_SEM_event_peak_aligned_m_contra,'c');
    cd(outputdirmean);
    saveas(fignew,'male_mean_event_male_contra','epsc');
    save('mean_male_touching_male_contra.mat','male_n_m','male_mean_event_m_contra','male_SEM_event_m_contra','male_eventpeaks_mean_m_contra','male_eventpeaks_SEM_m_contra','male_mean_event_peak_aligned_m_contra','male_SEM_event_peak_aligned_m_contra');
...
try
    ...
    plot_male_event_f_peak_aligned=boundedline(xevents_nonempty{1,1},male_mean_event_peak_aligned_f,male_SEM_event_peak_aligned_f,'c');
    
    cd(outputdirmean);
    saveas(fignew,'male_mean_event_female_ipsi','epsc');
    save('mean_female_touching_male_ipsi.mat','male_n_f','male_mean_event_f','male_SEM_event_f','male_eventpeaks_mean_f','male_eventpeaks_SEM_f','male_mean_event_peak_aligned_f','male_SEM_event_peak_aligned_f');
...
try
    ...
    plot_male_event_f_contra_peak_aligned=boundedline(xevents_nonempty_contra{1,1},male_mean_event_peak_aligned_f_contra,male_SEM_event_peak_aligned_f_contra,'c');
    
    cd(outputdirmean);
    saveas(fignew,'male_mean_event_female_contra','epsc');
    save('mean_female_touching_male_contra.mat','male_n_f','male_mean_event_f_contra','male_SEM_event_f_contra','male_eventpeaks_mean_f_contra','male_eventpeaks_SEM_f_contra','male_mean_event_peak_aligned_f_contra','male_SEM_event_peak_aligned_f_contra');
...
try
    ...
    plot_male_event_mf_peak_aligned=boundedline(xevents_nonempty{1,1},male_mean_event_peak_aligned_mf,male_SEM_event_peak_aligned_mf,'c');
    
    cd(outputdirmean);
    saveas(fignew,'male_mean_event_mated_female_ipsi','epsc');
    save('mean_mated_female_touching_male_ipsi.mat','male_n_mf','male_mean_event_mf','male_SEM_event_mf','male_eventpeaks_mean_mf','male_eventpeaks_SEM_mf','male_mean_event_peak_aligned_mf','male_SEM_event_peak_aligned_mf');
...
try
    ...
    plot_male_event_mf_contra_peak_aligned=boundedline(xevents_nonempty_contra{1,1},male_mean_event_peak_aligned_mf_contra,male_SEM_event_peak_aligned_mf_contra,'c');
    
    cd(outputdirmean);
    saveas(fignew,'male_mean_event_mated_female_contra','epsc');
    save('mean_mated_female_touching_male_contra.mat','male_n_mf','male_mean_event_mf_contra','male_SEM_event_mf_contra','male_eventpeaks_mean_mf_contra','male_eventpeaks_SEM_mf_contra','male_mean_event_peak_aligned_mf_contra','male_SEM_event_peak_aligned_mf_contra');
...
try
    ...
    save('mean_male_touching_oenocyteless_male_ipsi.mat','oenegm_n_m','oenegm_mean_event_m','oenegm_SEM_event_m','oenegm_eventpeaks_mean_m','oenegm_eventpeaks_SEM_m');
...
try
    ...
    save('mean_male_touching_oenocyteless_male_contra.mat','oenegm_n_m','oenegm_mean_event_m_contra','oenegm_SEM_event_m_contra','oenegm_eventpeaks_mean_m_contra','oenegm_eventpeaks_SEM_m_contra');
...
try
    ...
    save('mean_female_touching_oenocyteless_male_ipsi.mat','oenegm_n_f','oenegm_mean_event_f','oenegm_SEM_event_f','oenegm_eventpeaks_mean_f','oenegm_eventpeaks_SEM_f');
...
try
    ...
    save('mean_female_touching_oenocyteless_male_contra.mat','oenegm_n_f','oenegm_mean_event_f_contra','oenegm_SEM_event_f_contra','oenegm_eventpeaks_mean_f_contra','oenegm_eventpeaks_SEM_f_contra');
...
try
    ...
    save('mean_mated_female_touching_oenocyteless_male_ipsi.mat','oenegm_n_mf','oenegm_mean_event_mf','oenegm_SEM_event_mf','oenegm_eventpeaks_mean_mf','oenegm_eventpeaks_SEM_mf');
...
try
    ...
    save('mean_mated_female_touching_oenocyteless_male_contra.mat','oenegm_n_mf','oenegm_mean_event_mf_contra','oenegm_SEM_event_mf_contra','oenegm_eventpeaks_mean_mf_contra','oenegm_eventpeaks_SEM_mf_contra');
...
try
    ...
    save('mean_male_touching_oenocyteless_female_ipsi.mat','oenegf_n_m','oenegf_mean_event_m','oenegf_SEM_event_m','oenegf_eventpeaks_mean_m','oenegf_eventpeaks_SEM_m');
...
try
    ...
    save('mean_male_touching_oenocyteless_female_contra.mat','oenegf_n_m','oenegf_mean_event_m_contra','oenegf_SEM_event_m_contra','oenegf_eventpeaks_mean_m_contra','oenegf_eventpeaks_SEM_m_contra');
...
try
    ...
    save('mean_female_touching_oenocyteless_female_ipsi.mat','oenegf_n_f','oenegf_mean_event_f','oenegf_SEM_event_f','oenegf_eventpeaks_mean_f','oenegf_eventpeaks_SEM_f');
...
try
    ...
    save('mean_female_touching_oenocyteless_female_contra.mat','oenegf_n_f','oenegf_mean_event_f_contra','oenegf_SEM_event_f_contra','oenegf_eventpeaks_mean_f_contra','oenegf_eventpeaks_SEM_f_contra');
...
try
    ...
    save('mean_mated_female_touching_oenocyteless_female_ipsi.mat','oenegf_n_mf','oenegf_mean_event_mf','oenegf_SEM_event_mf','oenegf_eventpeaks_mean_mf','oenegf_eventpeaks_SEM_mf');
...
try
    ...
    save('mean_mated_female_touching_oenocyteless_female_contra.mat','oenegf_n_mf','oenegf_mean_event_mf_contra','oenegf_SEM_event_mf_contra','oenegf_eventpeaks_mean_mf_contra','oenegf_eventpeaks_SEM_mf_contra');
...
try
    ...
    save('mean_male_touching_ball_ipsi.mat','ball_mean_event_m','ball_n_m','ball_SEM_event_m','ball_eventpeaks_mean_m','ball_eventpeaks_SEM_m');
...
try
    ...
    save('mean_male_touching_ball_contra.mat','ball_n_m','ball_mean_event_m_contra','ball_SEM_event_m_contra','ball_eventpeaks_mean_m_contra','ball_eventpeaks_SEM_m_contra');
...
try
    ...
    save('mean_female_touching_ball_ipsi.mat','ball_n_f','ball_mean_event_f','ball_SEM_event_f','ball_eventpeaks_mean_f','ball_eventpeaks_SEM_f');
...
try
    ...
    save('mean_female_touching_ball_contra.mat','ball_n_f','ball_mean_event_f_contra','ball_SEM_event_f_contra','ball_eventpeaks_mean_f_contra','ball_eventpeaks_SEM_f_contra');
...
try
    ...
    save('mean_mated_female_touching_ball_ipsi.mat','ball_n_mf','ball_mean_event_mf','ball_SEM_event_mf','ball_eventpeaks_mean_mf','ball_eventpeaks_SEM_mf');
...
try
    ...
    save('mean_mated_female_touching_ball_contra.mat','ball_n_mf','ball_mean_event_mf_contra','ball_SEM_event_mf_contra','ball_eventpeaks_mean_mf_contra','ball_eventpeaks_SEM_mf_contra');
...
function [touchstartframes,eventsmat,eventpeaks,eventpeaks_mean,eventpeaks_SEM,mean_event,SEM_event,touchtimes,fluo,x_events,mean_event_peak_aligned,SEM_event_peak_aligned] = find_touch_events(data,options)
framerate = options.framerate;
numframes = options.numframes;
touchdir = options.touchdir;
resultsdir = options.resultsdir;
...
%function for aligning the events to the peak
