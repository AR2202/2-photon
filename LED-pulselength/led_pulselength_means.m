...
startdir=pwd;
pathname='/Users/annika/Documents/projects/dsx_GABAergic_neurons/imaging/LC10-lexA_lexAop-CSChrimson_dsx-GABA_GCaMP6f/Results';
%pathname has to be the path to the folder were files to be processed are
%located

stackdir = ('/Users/annika/Documents/projects/dsx_GABAergic_neurons/imaging/LC10-lexA_lexAop-CSChrimson_dsx-GABA_GCaMP6f/Results');
% The folder where the results of single experiments are located
outputdirmean=('/Users/annika/Documents/projects/dsx_GABAergic_neurons/imaging/LC10-lexA_lexAop-CSChrimson_dsx-GABA_GCaMP6f/Results');
...
files{ii}{ee} = dir(strcat('*_',namestrings(nn,:)));
...
filenames(:) = {''};
        ...
        for gg = 1:length(files{ii}{ee})
            ...
            if ismember('middle_sup',sheets)== 1
                middle_sup = table2array(readtable(filename,'Sheet','middle_sup','ReadVariableNames',0));
            ...
            if ismember('lateral',sheets)== 1
                lateral = table2array(readtable(filename,'Sheet','lateral','ReadVariableNames',0));
                 if exist('laterals') ==1
            ...
            if ismember('lat_cellbodies',sheets)== 1
                lat_cellbodies = table2array(readtable(filename,'Sheet','lat_cellbodies','ReadVariableNames',0));
           ...
           if ismember('dorsal_sup',sheets)== 1
                dorsal_sup = table2array(readtable(filename,'Sheet','dorsal_sup','ReadVariableNames',0));
           ...
           if ismember('middle_deep',sheets)== 1
                middle_deep = table2array(readtable(filename,'Sheet','middle_deep','ReadVariableNames',0));
            ...
            if ismember('frontal_sup',sheets)== 1%check if the excel file contains a sheet named "frontal_sup"
                frontal_sup = table2array(readtable(filename,'Sheet','frontal_sup','ReadVariableNames',0));
        ...
        if exist('middle_sups', 'var') == 1
           middle_sup_mean=mean(middle_sups,2);
            ...
            writetable(Tmiddle_sup,outfile,'Sheet','middle_sup','WriteVariableNames',true);
            writetable(Tnmiddle_sup,outfile,'Sheet','middle_sup','Range','C1','WriteVariableNames',true);
            %make figure
            newStr = strrep(namestrings(nn,:),'.xlsx','.eps');
            outputfig=strcat('middle_sup',newStr);
            fignew=figure('Name',outputfig);
        ...
        if exist('frontal_sups', 'var') == 1
           frontal_sup_mean=mean(frontal_sups,2);
            ...
            writetable(Tfrontal_sup,outfile,'Sheet','frontal_sup','WriteVariableNames',true);
            writetable(Tnfrontal_sup,outfile,'Sheet','frontal_sup','Range','C1','WriteVariableNames',true);
            %make figure
            newStr = strrep(namestrings(nn,:),'.xlsx','.eps');
            outputfig=strcat('frontal_sup',newStr);
            fignew=figure('Name',outputfig);
        ...
        if exist('laterals', 'var') == 1
           lateral_mean=mean(laterals,2);
            ...
            writetable(Tlateral,outfile,'Sheet','lateral','WriteVariableNames',true);
            writetable(Tnlateral,outfile,'Sheet','lateral','Range','C1','WriteVariableNames',true);
        %make figure
            newStr = strrep(namestrings(nn,:),'.xlsx','.eps');
            outputfig=strcat('lateral',newStr);
            fignew=figure('Name',outputfig);
        ...
        if exist('lat_cellbodiess', 'var') == 1
           lat_cellbodies_mean=mean(lat_cellbodiess,2);
            ...
            writetable(Tlat_cellbodies,outfile,'Sheet','lat_cellbodies','WriteVariableNames',true);
            writetable(Tnlat_cellbodies,outfile,'Sheet','lat_cellbodies','Range','C1','WriteVariableNames',true);
        %make figure
            newStr = strrep(namestrings(nn,:),'.xlsx','.eps');
            outputfig=strcat('lat_cellbodies',newStr);
            fignew=figure('Name',outputfig);
        ...
        if exist('dorsal_sups', 'var') == 1
           dorsal_sup_mean=mean(dorsal_sups,2);
            ...
            writetable(Tdorsal_sup,outfile,'Sheet','dorsal_sup','WriteVariableNames',true);
            writetable(Tndorsal_sup,outfile,'Sheet','dorsal_sup','Range','C1','WriteVariableNames',true);
        %make figure
            newStr = strrep(namestrings(nn,:),'.xlsx','.eps');
            outputfig=strcat('dorsal_sup',newStr);
            fignew=figure('Name',outputfig);
        ...
        if exist('middle_deeps', 'var') == 1
           middle_deep_mean=mean(middle_deeps,2);
            ...
            writetable(Tmiddle_deep,outfile,'Sheet','middle_deep','WriteVariableNames',true);
            writetable(Tnmiddle_deep,outfile,'Sheet','middle_deep','Range','C1','WriteVariableNames',true);
        %make figure
            newStr = strrep(namestrings(nn,:),'.xlsx','.eps');
            outputfig=strcat('middle_deep',newStr);
            fignew=figure('Name',outputfig);
